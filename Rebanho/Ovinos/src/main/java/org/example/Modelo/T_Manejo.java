...
public class T_Manejo extends EntidadeBase{
    ...
    public T_Manejo(int id_cordeiro, int id_cordeiro1, int n_brinco, Date data_manejo, int grau_famacha, String vermifugo_oral, String vermifugo_muscular, String vermifugo_venoso, String nome_vermifugo, String presenca_bicheira, String nome_medicamento) {
        super(id_cordeiro);
